...
class Preset_Every_Scroll():
    ...
    def __main_window_layout(self):
        ...
        self.create.column(layout=self.header_layout, width_percent=100)
        self.create.cell(layout=self.header_layout, hover_highlight=True)
    ...
    def build_main(self, win_dict, window_name, win_form=None):
        ...
        self.create.event_call_back(layout=self.header_layout, func=win_form[0], positive_args=win_form[1], negative_args=win_form[1], scrollable=True)
