...
class Vanilla_Behavior():
    ...
    def update(self, event):
        ...
        #Adjust the X, Y, Z of the active array
    ...
    def ray_snap(self, event):
        ...
        result, location, normal, index, object, matrix = scene_ray_cast(self.context, event)
    ...
    def new_ui(self, context):
        ...
        if self.master.should_build_fast_ui():
            ...
            if props.logic_state == Logic_States.VANILLA_ARRAY:
                ...
                # Help
                help_items["STANDARD"] = [
                    ("1, 2, 3",           "Numbers across top of keyboard change mode."),
                    ("V, B, N",           "Change the mode."),
                    ("Ctrl + Shift",      "Raycast snap to another object"),
                    ("NUMPAD",            "Set the current offset to the numpad value"),
                    ("Ctrl + Wheel Down", "Minus the count of the array"),
                    ("Ctrl + Wheel Up",   "Add to the count of the array"),
                    ("Numpad +",          "Adjust the offset by + 1"),
                    ("Numpad -",          "Adjust the offset by - 1"),
                    ("S",                 "Snap to the cursor"),
                    ("C",                 "Set array to constant offset"),
                    ("R",                 "Set array to relative offset"),
                    ("X",                 "Change the current axis being modified"),
                    ("Ctrl + X",          "Clear the axis offset"),
                    ("Alt + A",           "Remove current array"),
                    ("A",                 "Add additional array"),
                    ("Q",                 "Cycle active array"),
                    ("Ctrl + Move",       "Adjust array offset")]
                ...
                help_items["STANDARD"] = [
                    ("1, 2, 3",          "Numbers across top of keyboard change mode."),
                    ("V, B, N",          "Change the mode."),
                    ("Ctrl + MouseWheel", "Adjust the count of the arrays"),
                    ("Ctrl + MouseMove", "Adjust the offset of array"),
                    ("Ctrl + Shift",     "Raycast snap to another object"),
                    ("S",                "Snap to the cursor"),
                    ("R",                "Change radial to 180/90/45/30"),
                    ("X",                "Switch offset direction"),
                    ("Ctrl + Move",      "Adjust displacement offset"),
                    ("1",                 "To remove, switch to standard and press alt + A")]
                ...
                help_items["STANDARD"] = [
                    ("1, 2, 3",           "Numbers across top of keyboard change mode."),
                    ("V, B, N",           "Change the mode."),
                    ("Shift + Alt",       "Adjust the angle of simple deform"),
                    ("Ctrl + MouseWheel", "Adjust the count of the arrays"),
                    ("Ctrl + Shift",      "Raycast snap to another object"),
                    ("Ctrl + MouseMove",  "Adjust the offset of array"),
                    ("S",                 "Snap to the cursor"),
                    ("X",                 "Change the current axis being modified"),
                    ("Ctrl + Move",       "Adjust twist displacement offset"),
                    ("1",                 "To remove, switch to standard and press alt + A")]
            ...
            if props.logic_state == Logic_States.RADIAL_ARRAY:
                ...
                self.master.receive_fast_ui(win_list=win_list, help_list=help_items, image="ATwist360", mods_list=mods_list, active_mod_name=active_mod)
            else:
