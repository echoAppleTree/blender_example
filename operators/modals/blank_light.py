...
class HOPS_OT_Blank_Light(bpy.types.Operator):
    ...
    def modal(self, context, event):
        ...
        elif event.type in {'WHEELUPMOUSE', 'WHEELDOWNMOUSE', 'LEFT_ARROW', 'RIGHT_ARROW'} and event.value == 'PRESS':
            if not self.master.is_mouse_over_ui():
                ...
                if self.edit_state == Edit_State.LIGHT_RIG:
                    ...
                    if event.type in {'WHEELUPMOUSE', 'RIGHT_ARROW'}:
