    ...
    def execute(self, context):
        ...
        # Single draw data
            ...
            if self.target_obj in bpy.data.objects.keys():
                ...
                set_uv_draw_data_single(obj, self.use_selected_faces)
...
def set_uv_draw_data_single(obj, use_selected_faces=False):
    ...
    mesh = obj.data
    container = build_and_append_draw_data(mesh)
    Data.containers.append(container)


def set_uv_draw_data_multi(context, use_selected_faces=False):
    '''Get a list of list vector 2 that represents the uv edges.  [[Vec2, Vec2, Vec2], ... ]'''
...
def build_and_append_draw_data(mesh, use_selected_faces=False):
