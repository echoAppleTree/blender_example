...
Press H for help."""
    ...
    def invoke(self, context, event):
        ...
        for object in self.objects:
            ...
            if "added_modifier" in self.displace_objects[object.name]:
        ...
        for object_name in self.displace_objects:
            ...
            if self.base_controls.scroll:
                if event.shift:
                    ...
                    direction_types = ["X", "Y", "Z", "CUSTOM_NORMAL", "RGB_TO_XYZ", "NORMAL"]
                    ...
                    if get_preferences().ui.Hops_extra_info:
                        bpy.ops.hops.display_notification(info=f"{modifier.direction}" )
            ...
            #     modifier.direction = "X"
                ...
                bpy.ops.object.modifier_move_down(modifier=modifier.name)
                 ...
                 modifier.strength = 0
                 if get_preferences().ui.Hops_extra_info:
                     bpy.ops.hops.display_notification(info=F'Strength : 0' )
