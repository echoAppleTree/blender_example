...
def draw(preference, context, layout):
    ...
    if preference.color.hud_expand:
        ...
        sub_box = sub_box.box()
        label_row(preference.color, 'Hops_mirror_modal_scale', sub_box.row(), label='Mirror Scale')
        label_row(preference.color, 'Hops_mirror_modal_sides_scale', sub_box.row(), label='Mirror Sides')
