...
def draw(preference, context, layout):
    ...
    sub_box = col.box()
    header_row(sub_box.row(align=True), 'expand_sharpen', label='Sharpen keymap')
    if preference.keymap.expand_sharpen:
        sub_box = sub_box.box()
        sub_box.label(text='Sharpen Activation Hotkeys')
        sub_box.separator()
        ...
        sub_box.prop(preference.keymap, "sharp_shift_ctrl", text="Shift + Ctrl")
        sub_box.separator()
        sub_box.separator()
