...
class HOPS_MT_ObjectsOperatorsSubmenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        # op.all=True
        # op.additive=True
        op = column.operator("hops.ever_scroll", text="Modifier Scroll", icon_value=get_icon_id("StatusReset"))
        op.entry_state='MOD'
        op.fas_UI=False
...
class HOPS_MT_BoolScrollOperatorsSubmenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("hops.ever_scroll", text="Ever Scroll", icon_value=get_icon_id("QGui"))
