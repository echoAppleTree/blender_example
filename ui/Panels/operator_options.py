...
class HOPS_PT_operator_options(Panel):
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.prop(preference, 'bevel_profile', text='Default Profile')
        row = column.row(align=True)
        row.prop(preference, 'default_segments', text='Default Segments')
        row = column.row(align=True)
        row.prop(preference, 'bevel_miter_outer')
        row = column.row(align=True)
        row.prop(preference, 'bevel_miter_inner')
