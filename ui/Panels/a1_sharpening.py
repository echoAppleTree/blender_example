...
class HOPS_PT_SharpPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.prop(get_preferences().property, "sharp_use_crease", text="Apply crease")
        col.prop(get_preferences().property, "sharp_use_bweight", text="Apply bweight")
        col.prop(get_preferences().property, "sharp_use_seam", text="Apply seam")
        col.prop(get_preferences().property, "sharp_use_sharp", text="Apply sharp")
