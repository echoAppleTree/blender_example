...
class HOPS_OT_FacegrateOperator(bpy.types.Operator):
    ...
    def grate_faces(self, bm, selection ):
        ...
        result2 = bmesh.ops.inset_individual(bm, faces= join['faces'], thickness = self.shrink, depth = -self.ridge, 
           use_even_offset = True, use_interpolate = True , use_relative_offset = False,  )
    ...
    def draw_ui(self, context):
        ...
        if self.master.should_build_fast_ui():
            ...
            help_items["STANDARD"] = [
                ...
                ("RMB", "Cancel"),
                ("Scroll", "Divisions"),
                ("CTRL+Mouse", "Adjust Inset"),
                ("Mouse", "Adjust Ridge"),
                ("S", "Toggle Shrink mode")]
    ...
    def draw_ui(self, context):
        ...
        if self.master.should_build_fast_ui():
            ...
            help_items["STANDARD"] = [
                ...
                ("RMB", "Cancel"),
                ("S", "Toggle Shrink"),
                ("CTRL+Scroll", "Adjust Profile"),
                ("CTRL+Mouse", "Adjust Bevel"),
                ("Mouse", "Adjust Depth")]
