...
def user_sort(obj):
    ...
    sort(obj, option=addon.preference().property, ignore=bevs, sort_depth=sort_depth)
...
def sort(obj, option=None, ignore=[], sort_types=sort_types, last_types=[], first=False, static_sort=False, ignore_hidden=True, sort_depth=0):
    modifiers = []
